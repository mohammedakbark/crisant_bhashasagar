        ...
        : BlocBuilder<AuthApiControllerBloc, AuthApiControllerState>(
          builder: (context, state) {
            if (state is AuthApiFetchProfileState) {
              ...
              _emailController.text = state.profileModel.customerEmailAddress;
              _genderController.text = state.profileModel.customerGender;
              _ageController.text = state.profileModel.customerAge;
              _addressController.text = state.profileModel.customerAddress;
