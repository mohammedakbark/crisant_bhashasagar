...
import 'package:bashasagar/features/notification/data/repo/set_notification_token_repo.dart';
...
Future<void> onBackgroundNotificationResponse(
  ...
  if (response.payload != null) {
    NotificationService.handleNotificationClick(response.payload!);
  }
}
