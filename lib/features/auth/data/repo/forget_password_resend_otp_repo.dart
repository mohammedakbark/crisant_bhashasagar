...
class ForgetPasswordResendOtpRepo {
  static Future<ApiDataModel> onResendOTP({required String customerId}) async {
    try {
      final userData = await CurrentUserPref.getUserData;

      final response = await ApiConfig.postRequest(
        endpoint: ApiConst.foregetPasswordResend,
        body: {"customerId": customerId, "uiLanguageId": userData.uiLangId},
