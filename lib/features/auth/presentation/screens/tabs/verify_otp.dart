          ...
          child: Form(
            ...
            child: AppMargin(
              child: Column(
                children: [
                  Text(
                    getUilang.uiText(placeHolder: "OTP001").toUpperCase(),
                    ...
                    builder: (context, state) {
                      return state.timer == null
                          ? TextButton(
                            ...
                            child: Text(
                              getUilang.uiText(placeHolder: "OTP002"),
                  ...
                  BlocBuilder<AuthApiControllerBloc, AuthApiControllerState>(
                    builder: (context, state) {
                      return AppCustomButton(
                        ...
                        title: getUilang.uiText(placeHolder: "OTP003"),
                        onTap: () {
                  ...
                  Row(
                    ...
                    children: [
                      Text(getUilang.uiText(placeHolder: "OTP004"), style: AppStyle.normalStyle()),
                      TextButton(
                        onPressed: () {
                          context
                              .read<AuthStateControllerCubit>()
