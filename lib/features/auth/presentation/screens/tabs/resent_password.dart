          ...
          child: Form(
            ...
            child: AppMargin(
              child: Column(
                children: [
                  Text(
                    getUilang.uiText(placeHolder: "REP001").toUpperCase(),
                  ...
                  CustomeTextField(
                    ...
                    lebelText: getUilang.uiText(placeHolder: "REP002"),
                  ...
                  CustomeTextField(
                    isObsecure: true,
                    prefix: Icon(SolarIconsOutline.lock),
                    lebelText: getUilang.uiText(placeHolder: "REP003"),
                  ...
                  BlocBuilder<AuthApiControllerBloc, AuthApiControllerState>(
                    builder: (context, state) {
                      return AppCustomButton(
                        ...
                        title: getUilang.uiText(placeHolder: "REP004"),
                        onTap: () {
                  ...
                  Row(
                    ...
                    children: [
                      Text(getUilang.uiText(placeHolder: "REP005"), style: AppStyle.normalStyle()),
                      TextButton(
                        onPressed: () {
                          context
                              .read<AuthStateControllerCubit>()
