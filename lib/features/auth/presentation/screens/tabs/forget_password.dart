    ...
    return initializingUI
        ...
        : Container(
          ...
          child: Form(
            key: _formKey,
            child: AppMargin(
              child: BlocBuilder<AuthApiControllerBloc, AuthApiControllerState>(
                builder: (context, state) {
                  return Column(
                    children: [
                      Text(
                        getUilang.uiText(placeHolder: "FGP001").toUpperCase(),
                      ...
                      CustomeTextField(
                        ...
                        lebelText: getUilang.uiText(placeHolder: "FGP002"),
                        ...
                        builder: (context, state2) {
                          return state2.timer == null
                              ? TextButton(
                                ...
                                child: Text(
                                  getUilang.uiText(placeHolder: "FGP004"),
                      ...
                      AppCustomButton(
                        title: getUilang.uiText(placeHolder: "FGP005"),
                        onTap:
                            !state.enableResetButton
                                ? null
                                : () {
                      ...
                      AppSpacer(hp: .01),
                      if (state is AuthApiControllerLoadingState) AppLoading(),
                      AppSpacer(hp: .01),
                      Row(
