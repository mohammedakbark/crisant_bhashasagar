          ...
          child: Form(
            ...
            child: AppMargin(
              child: Column(
                children: [
                  Text(
                    getUilang.uiText(placeHolder: "REG001").toUpperCase(),
                  ...
                  CustomeTextField(
                    ...
                    lebelText: getUilang.uiText(placeHolder: "REG002"),
                  ...
                  CustomeTextField(
                    ...
                    lebelText: getUilang.uiText(placeHolder: "REG003"),
                  ...
                  CustomeTextField(
                    ...
                    lebelText: getUilang.uiText(placeHolder: "REG004"),
                  ...
                  CustomeTextField(
                    isObsecure: true,
                    prefix: Icon(SolarIconsOutline.lock),
                    lebelText: getUilang.uiText(placeHolder: "REG005"),
                  ...
                  BlocBuilder<AuthApiControllerBloc, AuthApiControllerState>(
                    builder: (context, state) {
                      return AppCustomButton(
                        ...
                        title: getUilang.uiText(placeHolder: "REG006"),
                        onTap: () {
                  ...
                  Row(
                    ...
                    children: [
                      Text(getUilang.uiText(placeHolder: "REG007"), style: AppStyle.normalStyle()),
                      TextButton(
                        onPressed: () {
                          context
