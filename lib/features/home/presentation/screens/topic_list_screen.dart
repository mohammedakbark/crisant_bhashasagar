...
class TopicListScreen extends StatelessWidget {
  ...
  const TopicListScreen({super.key, required this.language});
                ...
                children: [
                  SizedBox(
                    ...
                    child: LinearProgressIndicator(
                      ...
                      value: .6,
   color: Colors.amber,                      backgroundColor: AppColors.kWhite,
                    ),
                  ),
                                  AppSpacer(hp: .005),
      ...
      body: GridView.builder(
        ...
        itemBuilder:
            (context, index) => GestureDetector(
              onTap: () => context.push(visualLearningScreen,extra: {"language":language}),
